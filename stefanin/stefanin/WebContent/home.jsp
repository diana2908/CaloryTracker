...
</head>http://localhost:4200/#myCarousel
<body background="Media/bg1.jpg">
    <!--Navbar-->
  <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
          <div class="navbar-header">
              ...
              <a href="home.jsp" class="navbar-brand" ><i class="fas fa-utensils"></i> <span><i class="fas fa-calculator"></i></span></a>
          </div>
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">                 
                  <li><a href="login.jsp">Profile</a> </li>
                  <li><a href="login.jsp">Daily Plan</a></li> 
              </ul>
